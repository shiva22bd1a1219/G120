...
const HomePage = () => {
  ...
  if (!isAuthenticated ) {
    return (
      <div style={weh}>
        <p style={ajfeb}>Please log in to View Evidence.</p>
    ...
    <>
        <div className="first">
          ...
          <div className="fir_buttons" >
            <Link to="/writeee">
              <button className="fir_options" style={fir_options}>Write Evidence</button>
            </Link>
            <Link to="/readdd">
              <button className="fir_options" style={fir_options}>Read Evidence</button>
            </Link>
          </div>
        </div>
